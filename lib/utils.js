...
export function formatDateToGermanTime(dateString, options = {}) {
  ...
  // Standard-Optionen für deutsches Format mit Zeitzone Europe/Berlin (CET/CEST)
  const defaultOptions = {
    ...
    minute: '2-digit',
    second: '2-digit',
    timeZoneName: 'short',  // Zeigt "CET" oder "CEST" an
    ...options
  }
 ...
 * @param {string|Date} dateString - ISO-Datum-String oder Date-Objekt
 * @returns {string} Formatiertes Datum in deutscher Zeitzone (Europe/Berlin)
 */
export function formatDateShort(dateString) {
  ...
  // Konvertiert UTC zu Europe/Berlin (CET/CEST) Zeitzone
