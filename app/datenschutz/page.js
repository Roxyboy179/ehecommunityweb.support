        ...
        <Card className="bg-slate-900/50 border-blue-500/20 backdrop-blur-xl p-8 lg:p-12 max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-slate-300">
            ...
            <section>
              ...
              <Card className="bg-slate-800/50 border-blue-500/20 p-4 mb-4">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p>Sie haben das Recht, die Berichtigung Sie betreffender unrichtiger personenbezogener Daten zu verlangen.</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold mb-2 text-white">Recht auf Löschung</h3>
                  <p>Sie haben das Recht, die Löschung Ihrer gespeicherten personenbezogenen Daten zu verlangen.</p>
                </div>
                <div>
            ...
            <section>
              ...
              <p className="mb-4">Bei Fragen zum Datenschutz können Sie sich jederzeit an uns wenden:</p>
              <Card className="bg-slate-800/50 border-blue-500/20 p-4">
                <p><strong>E-Mail:</strong> <a href="mailto:hamburgrp20@gmail.com" className="text-blue-400 hover:text-blue-300">hamburgrp20@gmail.com</a></p>
              </Card>
            </section>
