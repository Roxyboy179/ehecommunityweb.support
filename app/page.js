  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white">
      ...
      <section className="py-12 relative">
        <div className="container mx-auto px-4">
          <Card className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border-blue-500/30 backdrop-blur-xl p-8 transition-all duration-700 hover:shadow-2xl hover:shadow-blue-500/30">
            <div className="text-center mb-6">
              <h2 className="text-3xl lg:text-4xl font-bold mb-3 text-white">
                Wichtige <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Informationen</span>
              </h2>
              <p className="text-lg text-white/90">So funktioniert unsere Plattform</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="flex flex-col items-center text-center p-4 bg-slate-900/30 rounded-lg border border-blue-500/20 hover:bg-slate-900/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">100% Kostenlos</h3>
                <p className="text-white/80">
                  Projektanfragen sind komplett kostenlos. Keine versteckten Kosten, keine Gebühren!
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4 bg-slate-900/30 rounded-lg border border-blue-500/20 hover:bg-slate-900/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Nur Sichtbarkeit</h3>
                <p className="text-white/80">
                  Wir machen dein bestehendes Projekt hier sichtbar - keine Entwicklung nötig!
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4 bg-slate-900/30 rounded-lg border border-blue-500/20 hover:bg-slate-900/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Kein Bot-Upload</h3>
                <p className="text-white/80">
                  Du musst KEINEN Discord Bot auf deinem Server hochladen. Einfach Projekt einreichen!
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link 
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-lg shadow-lg shadow-blue-500/30 hover:scale-105 transition-all duration-300"
              >
                AGB & Nutzungsbedingungen ansehen
